...
直接下载 [最新 Release](https://github.com/你的用户名/你的仓库名/releases) 中的 `LAN Transfer 懒人包.zip`，解压后双击 `server.exe` 即可使用。
...
电脑端界面	
手机端界面
https://./screenshots/pc.png	https://./screenshots/mobile.png
（请将截图文件放入 screenshots/ 文件夹，并在本处引用）
